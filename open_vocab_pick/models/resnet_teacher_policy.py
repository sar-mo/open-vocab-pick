...
class PointNavResNetTeacherPolicy(NetPolicy):
    def __init__(
        self,
        ...
        **kwargs: Any,
        ...
        backbone: Visual encoder backbone; one of ["resnet18", "resnet50", "resneXt50",
            "se_resnet50", "se_resneXt50", "se_resneXt101", "resnet50_clip_avgpool",
...
class ResNetTeacherEncoder(nn.Module):
    def __init__(
        self,
        observation_space: spaces.Dict,
        make_backbone: Callable,
        baseplanes: int = 32,
        ngroups: int = 32,
...
class PointNavResNetTeacherNet(Net):
    """Network which passes the input image through CNN and concfatenates
    ...
    def __init__(
        ...
        for uuid in [
            ...
            if uuid in observation_space.spaces:
                ...
                goal_visual_encoder = ResNetTeacherEncoder(
    ...
    def forward(
        ...
        if not self.is_blind:
            ...
            # self.visual_encoder(observations) is an expensive operation.
            # Therefore, we need `# noqa: SIM401`
            if (  # noqa: SIM401
